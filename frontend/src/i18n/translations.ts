...
export const translations: Record<Language, TranslationMap> = {
  "pt-BR": {
    ...
    "dashboard.description":
      "Nesta página você pode visualizar dados e estatísticas de todos os projetos em que participa.",
    "dashboard.welcome":
      "Bem-vindo, {{name}}! Essa página ainda está em construção e não aparece para usuários comuns.",
    "dashboard.loading": "Carregando...",
    "labelings.title": "Rotulações",
    "labelings.description":
      "Nessa página você pode ver estatísticas e responder as rotulações das quais faz parte.",
    "labelings.tooltip":
    ...
    "projects.description.restricted":
      "Apenas editores ou administradores podem acessar esta página.",
    "projects.tooltip":
    ...
    "labelings.upload.error.missingTitle":
      "Informe um título para a rotulação.",
    ...
    "labelings.create.formType.ariaLabel":
      "Selecionar tipo de formulário da rotulação",
    ...
    "labelings.create.guide.placeholder":
      "Digite suas instruções aqui... Você pode usar Markdown para formatação.",
    ...
    "labelings.create.decision.updateError":
      "Não foi possível salvar a pergunta decisiva.",
    "labelings.create.decision.title": "Decisão automática",
    "labelings.create.decision.description":
      "Esta rotulação está configurada para consolidar respostas automaticamente.",
    ...
    "labelings.create.errors.loadData":
      "Não foi possível carregar os dados da rotulação.",
    ...
    "labelings.create.errors.saveStructure":
      "Não foi possível salvar a estrutura da rotulação.",
    ...
    "labelings.create.delete.descriptionSuffix":
      "que deseja excluir esta rotulação?",
    ...
    "labelings.create.answers.exportSuccess":
      "Respostas exportadas com sucesso!",
    ...
    "answer.context.invalidVideo":
      "Vídeo inválido. Contate o dono da rotulação.",
