...
const meta = {
  title: 'ContextQuestion/QuestionModules/Number',
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'Number question module across AdminForm, UserLabeling and ResponseVisualization page types.',
      },
    },
  },
} satisfies Meta;
...
function NumberPageTypesDemo() {
  const summaryData = createQuestionResponseSummaryData('number');
