...
import { QuestionConfig, QUESTION_DEFAULTS, QUESTION_TYPE_COMPONENTS, QuestionTypeComponentProps } from './question-types';
...
export default function QuestionBlock({ data, onUpdate, onRemove }: QuestionBlockProps) {
  ...
  const TypeComponent = selectedType
    ? (QUESTION_TYPE_COMPONENTS[selectedType] as ComponentType<QuestionTypeComponentProps<QuestionConfig>>)
    : undefined;
        ...
        <div className="mb-3 flex items-center justify-between">
          ...
          <div className="flex items-baseline gap-4">
            ...
            <div className="flex items-center my-auto gap-2">
              <span className={`text-sm font-semibold transition-colors ${data.required ? 'text-blueberry-900' : 'text-gray-400'}`}>
