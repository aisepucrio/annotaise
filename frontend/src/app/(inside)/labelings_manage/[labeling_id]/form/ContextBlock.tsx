...
export type ContextType = 'text' | 'number' | 'date' | 'category' | 'code' | 'image' | 'audio' | 'video' | 'pdf';
    ...
    <GridItemCard index={1} className="mb-2">
      <div data-actions-anchor="true" data-section-element-id={data.id}>
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-blueberry-900 font-semibold text-sm">{t('labelings.create.context.title')}</h3>
          <button
            type="button"
        ...
        <div className="flex gap-2 mb-3">
          ...
          <Select
            ...
            options={[
              ...
              {
                value: 'audio',
                label: t('labelings.create.context.type.audio'),
              },
              {
                value: 'video',
                label: t('labelings.create.context.type.video'),
              },
