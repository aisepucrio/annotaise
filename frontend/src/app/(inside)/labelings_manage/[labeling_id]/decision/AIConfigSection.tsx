...
const KEY_STORAGE_OPTIONS: { value: KeyStorageMode; labelKey: string; hintKey: string }[] = [
  {
    value: 'server',
    labelKey: 'labelings.create.decision.aiConfig.storageServer',
    hintKey: 'labelings.create.decision.aiConfig.storageServerHint',
  },
  {
    value: 'local',
    labelKey: 'labelings.create.decision.aiConfig.storageLocal',
    hintKey: 'labelings.create.decision.aiConfig.storageLocalHint',
  },
];

export default function AIConfigSection({ labelingId, isLlmMode }: AIConfigSectionProps) {
        ...
        <fieldset className="mt-4">
          ...
          {storageMode === 'local' ? (
            <p className="mt-3 max-w-2xl text-xs text-gray-600">
              {t('labelings.create.decision.aiConfig.localScopeNotice')}
